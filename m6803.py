...
InstructionOperandTypes = [
	...
	INHER, INHER, INHER, INHER, INHER, INHER, INHER, INHER,  # 0x08
	INHER, INHER, NONE, NONE, NONE, NONE, INHER, INHER,  # 0x10
	NONE, INHER, NONE, INHER, NONE, NONE, NONE, NONE,  # 0x18
	REL, REL, REL, REL, REL, REL, REL, REL,  # 0x20
	REL, REL, REL, REL, REL, REL, REL, REL,  # 0x28
	INHER, INHER, INHER, INHER, INHER, INHER, INHER, INHER,  # 0x30
	INHER, INHER, INHER, INHER, INHER, INHER, INHER, INHER,  # 0x38
	INHER, NONE, NONE, INHER, INHER, NONE, INHER, INHER,  # 0x40
	INHER, INHER, INHER, NONE, INHER, INHER, INHER, INHER,  # 0x48
	INHER, NONE, NONE, INHER, INHER, NONE, INHER, INHER,  # 0x50
	INHER, INHER, INHER, NONE, INHER, INHER, INHER, INHER,  # 0x58
    INDXD, NONE, NONE, INDXD, INDXD, NONE, INDXD, INDXD,  # 0x60
    INDXD, INDXD, INDXD, NONE, INDXD, INDXD, INDXD, INDXD,  # 0x68
    EXTND, NONE, NONE, EXTND, EXTND, NONE, EXTND, EXTND,  # 0x70
    EXTND, EXTND, EXTND, NONE, EXTND, EXTND, EXTND, EXTND,  # 0x78
    IMMED, IMMED, IMMED, IMMED, IMMED, IMMED, IMMED, NONE,  # 0x80
    IMMED, IMMED, IMMED, IMMED, IMMED, REL, IMMED, NONE,  # 0x88
    DIR, DIR, DIR, DIR, DIR, DIR, DIR, DIR,  # 0x90
    DIR, DIR, DIR, DIR, DIR, DIR, DIR, DIR,  # 0x98
    INDXD, INDXD, INDXD, INDXD, INDXD, INDXD, INDXD, INDXD,  # 0xA0
    INDXD, INDXD, INDXD, INDXD, INDXD, INDXD, INDXD, INDXD,  # 0xA8
    EXTND, EXTND, EXTND, EXTND, EXTND, EXTND, EXTND, EXTND,  # 0xB0
    EXTND, EXTND, EXTND, EXTND, EXTND, EXTND, EXTND, EXTND,  # 0xB8
    IMMED, IMMED, IMMED, IMMED, IMMED, IMMED, IMMED, NONE,  # 0xC0
    IMMED, IMMED, IMMED, IMMED, IMMED, NONE, IMMED, NONE,  # 0xC8
    DIR, DIR, DIR, DIR, DIR, DIR, DIR, DIR,  # 0xD0
    DIR, DIR, DIR, DIR, DIR, DIR, DIR, DIR,  # 0xD8
    INDXD, INDXD, INDXD, INDXD, INDXD, INDXD, INDXD, INDXD,  # 0xE0
    INDXD, INDXD, INDXD, INDXD, INDXD, INDXD, INDXD, INDXD,  # 0xE8
    EXTND, EXTND, EXTND, EXTND, EXTND, EXTND, EXTND, EXTND,  # 0xF0
